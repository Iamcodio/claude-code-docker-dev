...
if check_container_running; then
    ...
    echo ""
    echo "3. Install core MCP servers:"
    echo "   npx claude mcp add context7 -- npx -y @upstash/context7-mcp"
    echo "   npx claude mcp add github -- npx -y @modelcontextprotocol/server-github"
    echo ""
